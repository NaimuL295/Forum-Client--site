...
const MyProfile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 sm:px-8 lg:px-12  rounded-xl shadow-lg">
   
      <div className=" p-6 rounded-xl shadow-lg flex flex-col items-center">
        <div className="relative">
          ...
          />
          <div className="absolute bottom-0 right-0  p-2 rounded-full shadow-md">
            <span className="text-2xl">{badge.icon}</span>
          </div>
        </div>
        <h2 className="text-3xl font-bold ">{users?.name}</h2>
      ...
      {/* Recent Posts */}
      <div className="mt-10">
        <h3 className="text-2xl font-semibold  mb-6">My Recent Posts</h3>
